  ...
  <div class="containerPrescri">
    <b-form inline>
      ...
      <b-input-group   size="sm" prepend="°" class="mb-2 mr-sm-2 mb-sm-0">
        <b-input size="sm" id="inline-form-input-username" placeholder="EIXO"></b-input>
      </b-input-group>
    ...
    <b-form inline class="mt-4">
      ...
      <b-input-group prepend="°"    size="sm" class="mb-2 mr-sm-2 mb-sm-0">
        <b-input id="inline-form-input-username" size="sm" placeholder="EIXO"></b-input>
      </b-input-group>
...
Retorno com 01 Ano"
 ...
 <b-button class="mr-3" pill variant="primary">Salvar</b-button>
 <b-button pill>Cancelar</b-button>
  </div>
</template>
